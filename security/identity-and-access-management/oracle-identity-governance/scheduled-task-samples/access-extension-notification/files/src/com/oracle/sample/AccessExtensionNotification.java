...
public class AccessExtensionNotification extends TaskSupport {
	...
	private Boolean processAccounts(String userKey, List<Account> userApplications) throws SQLException {
	...
	private Boolean processEntitlements(String userKey, Account currentAccount) throws SQLException {
		Boolean sendEmailEntitlements = false;
